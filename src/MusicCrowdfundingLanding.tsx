      ...
      <div className="container mx-auto px-4 py-12 pb-32 pt-20">
        <div className="text-center mb-12">
          ...
          <div className="mb-6 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-purple-300 mb-4 font-medium animate-fadeIn delay-500">
              Присоединяйтесь к <span className="text-pink-400 font-bold">{totalBackers} людям</span>, которые уже помогают создать что-то особенное ✨
            </p>
        ...
        <div className="max-w-3xl mx-auto mb-16 bg-gray-800/30 rounded-xl p-8 border border-purple-500/20 hover:border-purple-400/40 transition-all">
          ...
          <p className="text-center text-gray-400 mb-2 text-sm">
            Полная прозрачность: каждый рубль идет на создание музыки
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              { item: "Студия звукозаписи", cost: "₽15,000", percent: 30 },
              { item: "Съемка видеоклипа", cost: "₽20,000", percent: 40 },
              { item: "Постпродакшн и монтаж", cost: "₽8,000", percent: 16 },
              { item: "Визуальные эффекты", cost: "₽7,000", percent: 14 }
            ].map((item, i) => (
        ...
        <div className="max-w-4xl mx-auto mt-16 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              Станьте частью сообщества, которое создает что-то особенное вместе
            </p>
          </div>
            ...
            <div className="bg-gray-800/30 rounded-xl p-6 border border-purple-500/20">
              ...
              {showFAQ && (
                <div className="mt-6 space-y-4 animate-fadeIn">
                  {[
                    { q: 'Как я получу подарки?', a: 'Все подарки будут отправлены вам в течение 30 дней после завершения проекта. Цифровые материалы придут на вашу электронную почту.' },
                    { q: 'Что если проект не соберет нужную сумму?', a: 'Ваши средства будут возвращены в полном объеме. Мы гарантируем 100% возврат, если цель не будет достигнута.' },
                    { q: 'Когда будет готов трек?', a: 'Мы планируем завершить проект через 2-3 месяца после достижения цели. Вы будете получать регулярные обновления о прогрессе.' },
                    { q: 'Могу ли я изменить сумму поддержки?', a: 'Да, вы можете добавить к своей поддержке в любое время до окончания кампании.' },
                    { q: 'Как отслеживать прогресс проекта?', a: 'Мы будем публиковать еженедельные отчеты с фотографиями, видео и аудио записями процесса создания.' }
                  ].map((faq, idx) => (
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-gray-500 text-xs">Все средства идут напрямую на производство музыки и видео</p>
        </div>
      </div>
    </div>
  );
